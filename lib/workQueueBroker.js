...
WorkQueue = (function() {
  ...
  function WorkQueue(qmgr, queueName, options, send_, consume_) {
    this.qmgr = qmgr;
  ...
  WorkQueue.prototype.send = function(data) {
    this.send_(this.queueName, data);
    return this;
  };
...
WorkQueueBroker = (function(_super) {
  ...
  WorkQueueBroker.prototype.createQueue = function(queueName, options) {
    return this.queues[queueName] = new WorkQueue(this.qmgr, queueName, options, this.send.bind(this), this.consume.bind(this));
  };

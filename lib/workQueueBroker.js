...
WorkQueue = (function() {
  ...
  WorkQueue.prototype.ack_ = function(onData, cancel) {
    if (!cancel) {
      this.consume(onData);
    }
    return this;
  ...
  WorkQueue.prototype.consume = function(onData) {
    var _this = this;
    this.qmgr.pop(this.queueName, function(data) {
      return onData(data, _this.ack_.bind(_this, onData));
    });
    return this;
  };
...
WorkQueueBroker = (function(_super) {
  ...
  WorkQueueBroker.prototype.send = function(queueName, data) {
    if (this.isValidQueueName) {
      this.queues[queueName].send(data);
    }
    return this;
  };
  ...
  WorkQueueBroker.prototype.consume = function(queueName, onData) {
    if (this.isValidQueueName(queueName)) {
      this.queues[queueName].consume(onData);
    }
    return this;
  };

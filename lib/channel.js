...
var Channel, ChannelError, configurator, events,
...
Channel = (function(_super) {
  ...
  Channel.prototype.connect = function(onReady) {
    this.readyCntDn_ = 1;
    this.client = configurator.getClient(this.configFilePath);
  ...
  Channel.prototype.connect2 = function(onReady) {
    ...
    this.client = configurator.getClient(this.configFilePath);
    this.client.once('ready', this.onReady_.bind(this, onReady));
    this.client2 = configurator.getClient(this.configFilePath);
